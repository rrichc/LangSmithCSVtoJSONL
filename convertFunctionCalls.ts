// For reference: https://github.com/OpenPipe/OpenPipe/blob/main/app/src/server/utils/convertFunctionCalls.ts#L112
...
export const convertFunctionMessagesToToolCall = (
  ...
  messages.map(convertFunctionMessageToToolCall);
...
export const convertToolCallMessagesToFunction = (
  ...
  messages.map(convertToolCallMessageToFunction);
